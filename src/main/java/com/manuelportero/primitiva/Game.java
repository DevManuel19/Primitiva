...
public class Game {
    ...
    private int reintegro = 0;
    private int complementario = 0;
    private int aciertos = 0;
    private final String BOLETO_GANADOR = bombo.combinarValores();
    ...
    public String comprobarJuegoUnico(String boletoUsuario){
        String[] boletoGanadorStr = BOLETO_GANADOR.split(" ");
        ...
        int[] resultado ={aciertos,complementario,reintegro};
    ...
    public String hastaDiezMil (String boletoUsuario) {
        ...
        for (int z = 0; z <10000 ; z++) {
            ...
            if (aciertos == 6 && reintegro == 1){
                premioEspecial++;
            } else if (aciertos == 6) {
                primerPremio++;
            } else if (aciertos == 5 && reintegro == 1)  {
                segundoPremio++;
            } else if (aciertos == 5) {
                tercerPremio++;
            } else if (aciertos == 4) {
        ...
        return "En 10000 tiradas has obtenido:  "+ premioEspecial+"  premios especiales, "+primerPremio+"  de primera categoria,  "+segundoPremio+"  de sgunda categoria,  "+tercerPremio+"  de tercera categoria,  "+cuartoPremio+"  de cuarta categoria,  "+quintoPremio+"  de quinta categoria ";
    }
    ...
    public String hastaPremioEspecial (String boletoUsuario) {
        ...
        return "Han hecho falta "+ count +" intentos con la combinacion ganadora "+ BOLETO_GANADOR + " para obtener el premio de categoria especial";
    }
    ...
    public String getBOLETO_GANADOR() {
